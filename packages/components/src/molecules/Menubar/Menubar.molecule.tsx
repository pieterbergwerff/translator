...
export const MenubarMoleculeComponent = forwardRef<
...
MenubarMoleculeComponent.displayName = MenubarPrimitive.Root.displayName
...
export { MenubarMenu, MenubarGroup, MenubarPortal, MenubarSub, MenubarRadioGroup }

export default MenubarMoleculeComponent
